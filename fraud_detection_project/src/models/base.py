...
This module provides the base class for all fraud detection models.
"""
...
logger = logging.getLogger("fraud_detection.models.base")
...
class BaseFraudModel(ABC):
    ...
    All fraud detection models should inherit from this class
    ...
    @classmethod
    def load(cls, path: Union[str, Path]) -> "BaseFraudModel":
        """
